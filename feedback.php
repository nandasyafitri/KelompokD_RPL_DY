    					 ...
    					 <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12 form-group">
                                  <textarea style="width : 50%;" type="textarea" name="feedback" id="feedback" placeholder="Sampaikan Feedback anda disini..." maxlength="6000" rows="7"></textarea>
                                </div>
                            </div>
                                  <center> <input style="width: 10%; background: #e96147;"type="submit" class="btn btn-success btn-block" name="kirim" value="Kirim" /></center>
                            </div>
                        </form>
                        <?php
                          include 'koneksi.php';
