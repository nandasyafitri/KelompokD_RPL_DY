    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
        <ul class="nav navbar-nav">
          <li><a href="#tempat">Reservasi Meja</a></li>
								...
								<p><a href="#">no : 1<br><img src="asset\images\ta.png" class="img-responsive"><?php $result = mysqli_query($mysqli,"SELECT status FROM meja where no_meja=1");
								 ...
								 ?></a></p>
								  <div class="overlay">
    								<div class="text">
									<?php 
										$sql="SELECT pemesan,jam FROM meja where no_meja=1";
	                    ...
	                    <div class="reservation-page-form">
	                        ...
	                        <ul>
	                            <li>Buka setiap hari mulai <span>09:00 AM - 22:00 PM</span> </li>
													...
													<p><?php include 'pesan_tempat.php'; ?></p>
	                        <form id="reservation-form" action ="index.php" method="post">
															<div class="reservation-page-input-box">
	                                <label>Nama</label>
	                                <input type="text" class="form-control" placeholder="Nama Lengkap" name="nama" id="form-name" data-error="Subject field is required" required>
	                            </div>
	                            <div class="reservation-page-input-box">
	                                <label>Waktu</label>
	                                <span class="fa fa-calendar date_picker" aria-hidden="true">
	                                    <input type="text" placeholder="2018/12/31" name="tanggal" id="date-picker" data-error="Subject field is required" required> </span>
	                                    <span class="fa fa-clock-o time_picker" aria-hidden="true">
	                                        <input type="text" placeholder="06:00" name="jam" id="time-picker" data-error="Subject field is required" required>
	                                    </span>
	                                </div>
	                                <div class="reservation-page-input-box">
	                                    <label>No Hp</label>
	                                    <input type="text" class="form-control" placeholder="082211276007" name="hp" id="form-phone" data-error="Subject field is required" required>
	                                </div>
	                                <div class="reservation-page-input-box">
	                                    <label>Jumlah Kursi</label>
	                                    <input type="text" class="form-control rt-date" placeholder="6 orang" name="jumlah_kursi" id="form-date" data-error="Subject field is required" required>
	                                </div>
																	<div class="reservation-page-input-box">
																			<label>No Meja</label>
																			<span class="fa" aria-hidden="true">
																					<input type="text" placeholder="12" name="no_meja" id="no_meja" data-error="Subject field is required" required>
																			</span>
																	</div>

	                                <div class="reservation-booking">
	                                    <button type="submit" class="book-now-btn" name="pesan_tempat">Reservasi</button>
	                                </div>
										...
										<div class="agile_top_brand_left_grid">
											...
											<div class="agile_top_brand_left_grid1">
												<figure>
													<div class="snipcart-item block" >
														<div class="snipcart-thumb">
															<a href="products.html"><img src="asset/images/ayamgeprek.jpg" alt=" " height="244" title=" " /></a>
Nasi Ayam Geprek</p>
															<div class="stars">
																<i class="fa fa-star blue-star" aria-hidden="true"></i>
																<i class="fa fa-star blue-star" aria-hidden="true"></i>
