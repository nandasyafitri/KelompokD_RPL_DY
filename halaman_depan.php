														...
														<div class="snipcart-details top_brand_home_details">
															<form action="#" method="post">
																<fieldset>
																	...
																	<input type="hidden" name="food_01" value="Nasi Goreng" />
															...
															<?php if(isset($_POST['submit'])){
																if($_POST['add']>0){
																	$jumlah_pesanan = $_POST['add'];
																	$harga = $_POST['amount'];
																	$menu = $_POST['food_01'];
																	$sql= mysqli_query($mysqli, "INSERT INTO pesanan(jumlah_pesanan, harga, id_menu) values ('$jumlah_pesanan', '$harga','$menu')");
																}
															} ?>
														</div>
													</div>
