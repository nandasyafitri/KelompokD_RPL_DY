...
<div class="container">
    <div class="home-section text-center">
		<h3 style="padding-bottom: 50px;"class="w3ls-title"><span>P</span>ilih Mode</h3>
		<form id="pilih_mode" method="post" action="pilihan.php">
				<a href="tampil_meja.php"<button style="background: #e96147; color: #fff;" type="submit" class="btn btn-default btn-lg ">On The Spot</button></a>
				<a href="pesan_menu.php"<button style="background: #949c31; color: #fff;"type="button" name="takeHome" class="btn btn-default btn-lg ">Take Home</button></a>
		</form>
	</div>
	...
	<!--Petunjuk-->
			<h5 style="padding-left: 320px;padding-bottom: 50px;padding-top: 50px;" class="w3ls-title">Petunjuk:
				<li>Pilih 'On The Spot' jika hendak menikmati pesanan di kafe</li>
				<li>Pilih 'Take Home' jika pesanan ingin dibawa pulang</li></h5>
	<!--//Petunjuk-->
	</section>
    <!-- services -->
    <!-- services -->
