...
<head>
    ...
    <style>
		body{
		background: url('asset/images/gambarkopi.jpg');
    ...
    <div class="home-section text-center">
        <div class="register">
            <div class="login-form-grids">
              ...
              <h3>Data Registrasi Pengunjung</h3>
        <form action="register.php" method="POST">
          ...
          <?php include('errors.php'); ?>
            ...
            <div class="form-group">
                <p for="email">Email</p>
                <input class="form-control" type="email" name="email" placeholder="contoh: syafitrinanda@gmail.com" />
            </div>
            ...
            <div class="form-group">
                <p for="password">Konfirmasi Password</p>
                <input class="form-control" type="password" name="password_1" placeholder="masukkan password" />
            </div>
